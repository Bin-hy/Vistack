...
const (
	UserService_GetUserInfos_FullMethodName = "/auth.v1.UserService/GetUserInfos"
)
...
//
// UserService 提供用户公开信息的批量查询，供业务服务（api）在展示作者等场景调用。
type UserServiceClient interface {
	// GetUserInfos 按 user_id 列表批量返回用户公开信息。
